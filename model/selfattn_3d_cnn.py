...
from utils.SelfAttention3D import *


# Note: need to recompute dim sizes

class baseline_3DCNN(nn.Module):
    def __init__(self, in_num_ch=1, img_size=(40, 256, 256), inter_num_ch=4, kernel_size=3, conv_act='relu',
                 dropout=0.2):
        super().__init__()
        ...
        self.self_attn_3D = SelfAttention3D(embed_dim = 16*5*16*16, in_channels = 16, dropout=0.1)
